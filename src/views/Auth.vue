<template>
    <div>
        <div class="auth__mode">
            <button @click="signupForm" class="auth__switch">S'inscrire</button>
            <button @click="loginForm" class="auth__switch">Se connecter</button>
        </div>
        
        <div class="auth__container" id="auth__container">
